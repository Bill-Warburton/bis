...
%let qa_report = R:\working\users\jennys\production_data\qa\qa_msp_data_cleansing_report;
...
data msp_a(keep=studyid servdate pracnum feeitem servcode servloc clmtype paynum icd9_1-icd9_5 prov servunits expdamt record_type);
	set msp_a;
...
data msp_c(keep=studyid servdate pracnum feeitem servcode servloc clmtype paynum icd9_1-icd9_5 prov servunits expdamt record_type);
	set msp_c;
	format servdate  paiddate date9.;
...
by studyid servdate pracnum feeitem servcode servloc clmtype paynum icd9_1 icd9_2 icd9_3 icd9_4 icd9_5 prov;
run;
...
data datalib.&outfile(keep=studyid servdate pracnum feeitem servcode servloc clmtype paynum icd9_1 icd9_2 icd9_3 icd9_4 icd9_5 prov servunits expdamt medical);
